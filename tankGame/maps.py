...
def generate_map(screen_width, screen_height, tank_rect):
    obstacles = []
    ...
    for _ in range(num_obstacles):
        ...
        while True:
            ...
            # Check if the new obstacle collides with any existing obstacles or the tank
            if not any(obstacle_rect.colliderect(existing_obstacle['rect']) for existing_obstacle in obstacles) \
                    and not obstacle_rect.colliderect(tank_rect):
